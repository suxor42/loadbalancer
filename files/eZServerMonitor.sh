...
# Hosts to ping
PING_HOSTS=("33.33.33.80" "33.33.33.81")
...
function services()
{
    ...
    echo -e "${WHITE}$SERVER"
        ...
        do
            ...
            CHECK=`(ssh ubuntu@$SERVER -i .ssh/id_rsa -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o ConnectTimeout=1 exec 3<>/dev/tcp/$HOST/$PORT) &>/dev/null; echo $?`
